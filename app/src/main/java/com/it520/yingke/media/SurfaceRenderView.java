...
package com.it520.yingke.media;
...
//        this.getHolder().setFormat(PixelFormat.TRANSLUCENT);
    ...
    private static final class SurfaceCallback implements SurfaceHolder.Callback {
        ...
        public SurfaceCallback(@NonNull SurfaceRenderView surfaceView) {
            ...
            mBitmap = BitmapFactory.decodeResource(surfaceView.getResources(), R.mipmap.ic_launcher);
            mPaint = new Paint();
            mTransPaint = new Paint();
            mTransPaint.setAntiAlias(true);
            mTransPaint.setColor(Color.TRANSPARENT);
            mTransPaint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_OUT));
        }
        ...
        public void surfaceCreated(SurfaceHolder holder) {
            ...
            if(canvas!=null){
                canvas.drawColor(Color.RED, PorterDuff.Mode.DST_IN);
        ...
        public void surfaceChanged(SurfaceHolder holder, int format,
            ...
            if(canvas!=null){
//                canvas.drawColor(Color.RED, PorterDuff.Mode.DST_IN);
                canvas.drawCircle(100,100,100,mTransPaint);
                if(mBitmap!=null&&mPaint!=null){
                    canvas.drawBitmap(mBitmap,0,300,mTransPaint);
                }
                mSurfaceHolder.unlockCanvasAndPost(canvas);
            }*/
